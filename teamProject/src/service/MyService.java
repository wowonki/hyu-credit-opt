...
public class MyService {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("변수 %d를 포함한 문제들의 평균 소요 시간: %.2f초%n",variableIndex,service.getAverageTimeForVariable(variableIndex));
        System.out.printf("%.2f초 이내에 풀린 문제 번호: %s%n", maxTime, service.getProblemsSolvedWithinTime(maxTime));
